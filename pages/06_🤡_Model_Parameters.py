...
def __model_params__(model, x_train, n_samples):
    ...
    plt.savefig('model_params.png', bbox_inches='tight', dpi=100)
    figure = 'model_params.png'
    return figure, shap_values, explainer
...
if 'model' in st.session_state:
    ...
    if 'x_train' in st.session_state:
        ...
        t_t_ratio = st.session_state['t_t_ratio']
    ...
    caption = st.session_state['model_name'] + ' - feature influence on the output'
